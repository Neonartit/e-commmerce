...
<head>
    ...
    <link rel="stylesheet" href="{{ url('../../assets/css/css-login/main.css') }}" />
    <link rel="stylesheet" href="{{ url('../../assets/css/css-login/util.css') }}" />
    <!--===============================================================================================-->
</head>
...
<body>
    ...
    <!--===============================================================================================-->
    <script src="{{ url('../../assets/js/js-login/main.js') }}"></script>
